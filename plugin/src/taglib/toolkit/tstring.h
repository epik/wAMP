...
namespace TagLib {
  ...
  public:
    ...
    typedef eastl::basic_string<wchar>::iterator Iterator;
    typedef eastl::basic_string<wchar>::const_iterator ConstIterator;
#endif
     ...
     */
    String(const eastl::string &s, Type t = Latin1);
     ...
     * eastl::string.  If it is true the returned eastl::wstring will be UTF-8
     * encoded.
     */
    eastl::string to8Bit(bool unicode = false) const;
     ...
     */
    String &operator=(const eastl::string &s);
