...
namespace TagLib {
  ...
  /*!
   * This is basic generic list that's somewhere between a eastl::list and a
  ...
  public:
    ...
    typedef typename eastl::list<T>::const_iterator ConstIterator;
#endif
     ...
     * eastl::list::const_iterator for the semantics.
     */
    Iterator begin();

    /*!
     * Returns an STL style constant iterator to the beginning of the list.  See
     * eastl::list::iterator for the semantics.
     */
