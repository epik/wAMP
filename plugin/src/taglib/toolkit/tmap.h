...
namespace TagLib {
  ...
  public:
    ...
    // generally.
    typedef typename eastl::map<class Key, class T>::iterator Iterator;
    typedef typename eastl::map<class Key, class T>::const_iterator ConstIterator;
#else
    typedef typename eastl::map<Key, T>::iterator Iterator;
    typedef typename eastl::map<Key, T>::const_iterator ConstIterator;
#endif
#endif
     ...
     * eastl::map::iterator for the semantics.
     */
    Iterator begin();

    /*!
     * Returns an STL style iterator to the beginning of the map.  See
     * eastl::map::const_iterator for the semantics.
     */
