...
function wScroll()
{
	...
	wScroll.prototype.IgnoreInput = function()
	{
		this.bIgnoreInput = 1;
	};
	
	wScroll.prototype.AllowInput = function()
	{
		this.bIgnoreInput = 0;
	};
	...
	wScroll.prototype.mouseOutFix = function (event)
	{
		/*for (var i in event)
	...
	wScroll.prototype.YScrollTo = function (y, time, relative) 
	{
		this.scrollTo(y, time, relative);
	};
	...
	wScroll.prototype._SetFirstVisLabel = function(iTrigger)
	{
		if (iTrigger)
		{
	...
	wScroll.prototype.UseStickyHeader = function()
	{
		this.bStickyHeader = 1;
	};
	...
	wScroll.prototype.RecalcBottom = function(iScrollTo)
	{
		...
		this.wrapperH = $(this.divWrapper).height();
		
		this.scrollerH = $(this.ulParent).height();
		
		this.maxScrollY = (-1 * this.scrollerH) + (this.wrapperH);
		
		this.wrapperY = $(this.divWrapper).offset().top;
